  ...
  >
    <div class="pb-2 rounded shadow block mt-6">
      <table class="w-full text-center">
        ...
        <tbody>
          <tr
            v-for="(forum, index) in forumPagedResponse.forums"
            :key="forum.id"
        ...
        <div class="flex space-x-2 items-center">
          <template v-for="pageNumber in forumPagedResponse.pagesCount">
            <button
              ...
              v-bind:class="{
                'text-black border-2 border-black font-medium':
...
export default {
  ...
  data() {
    return {
      ...
      currentSortingProperty: 'creation_date' as ForumSortPropertyType,
      currentSortingOrder: 'desc' as ForumSortOrderType,
      ...
      try {
        const response = await axios.get<ForumPagedResponseType>('/forum', {
          params: {
            ...
            sorting_property: this.currentSortingProperty,
            sorting_order: this.currentSortingOrder,
          },
        });
